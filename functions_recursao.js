...
//Garantir o caso Base e que será mais compesação do que usar loops
...
function fatorial(n){
    if (n <= 1){  // Essa é a condição de parada da recursão, conhecida como caso base.
        return 1;
    }
...
function ehpalindromo(palavra, Palindromo)
    {
